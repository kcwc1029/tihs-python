...
character = [
    GameCharacter("曉之劍士「蓋亞」", 200, 200, 280, "swordsman.png", "LC"),
    GameCharacter("暗之忍者「半藏」", 160, 600, 280, "ninja.png", "RC")
]
character[0].draw()
character[1].draw()
